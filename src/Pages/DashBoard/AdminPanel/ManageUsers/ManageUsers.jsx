...
const ManageUsers = () => {
    ...
    const fetchUsers = async () => {
        try {
            const response = await axios.get('https://smc-server.vercel.app/users');
    ...
    const updateUserRole = async (userId, newRole) => {
        try {
            ...
            const response = await axios.patch(`https://smc-server.vercel.app/users/${userId}`, { role: newRole });
