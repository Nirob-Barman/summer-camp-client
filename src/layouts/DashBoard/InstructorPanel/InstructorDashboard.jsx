            ...
            <div className="flex flex-col md:flex-row">
                <div className="bg-white shadow-md md:w-1/5 p-4">
                    ...
                    <ul className="space-y-2">
                        ...
                        <li>
                            <Link className="text-blue-500">Students</Link>
                        </li>
                        <li>
                            <Link className="text-blue-500">Settings</Link>
                        </li>
                    </ul>
                </div>
                <div className="bg-white shadow-md md:flex-1 p-4">
                    {/* Main Content */}
                    <h2 className="text-2xl font-semibold mb-4">Welcome to Instructor Dashboard</h2>
