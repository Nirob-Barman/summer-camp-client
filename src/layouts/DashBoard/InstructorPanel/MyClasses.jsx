...
const MyClasses = () => {
    ...
    return (
        ...
        //                     <h3 className="text-lg font-semibold text-gray-800 mb-4">{classItem.classname}</h3>
        //                     <div className="flex justify-between items-center mb-4">
        //                         <span className="text-sm text-gray-600">{classItem.status}</span>
        //                         <span className="text-sm text-gray-600">
        //                             Enrolled: {classItem.enrolledStudents}
        //                         </span>
        //                     </div>
        //                     <p className="text-sm text-gray-600 mb-4">
        //                         {classItem.status === "denied" ? classItem.feedback : "No feedback available."}
        //                     </p>
